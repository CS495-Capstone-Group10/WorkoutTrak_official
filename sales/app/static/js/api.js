...
const post_workout_api = async (data, success) => {
  const token = await localStorage.getItem("salesToken");
  if (token === null) {
    console.log("No credentials found, redirecting...");
    window.location = "/login";
...
const put_workout_api = async (saleId, data, success) => {
  const token = await localStorage.getItem("salesToken");
  if (token === null) {
    console.log("No credentials found, redirecting...");
    window.location = "/login";
...
const get_workout_api = async (pageNo="", success, fail) => {
  const token = await localStorage.getItem("salesToken");
  if (token === null) {
    console.log("No credentials found, redirecting...");
    window.location = "/login";
...
const get_Atheletes_api = async (pageNo="", success, fail) => {
  const token = await localStorage.getItem("salesToken");
  if (token === null) {
    console.log("No credentials found, redirecting...");
    window.location = "/login";
...
const create_account = async (name, description, success, fail) => {
  const response = await fetch(
        `/create-group/`,
        {
            method: 'POST',
